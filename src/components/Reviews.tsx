     ...
     <div className="space-y-8">
       ...
       <div>
         <div className="flex items-center gap-2">
           <span className="font-miniver text-[#195A00] text-lg">Testimonials</span>
           <div className="w-8 h-[1px] bg-[#195A00]" />
         </div>
         <h2 className="text-4xl font-bold text-gray-800 mt-4">Customer Review</h2>
       </div>
     ...
     <div className="space-y-4">
       ...
       <Card className="p-6 space-y-4">
         ...
         <div className="flex gap-1">
           {[...Array(5)].map((_, i) => (
             <Star key={i} className="w-5 h-5 fill-[#195A00] text-[#195A00]" />
           ))}
         </div>

         <p className="text-gray-500">
           Lorem ipsum dolor sit amet, consectetur elit. Quisque diam pellentesque bibendum fringilla bibendum. Urna, elit
           augue urna,
         </p>
       </Card>
     </div>
