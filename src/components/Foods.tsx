  ...
  return (
    <div>
         ...
         <div className='w-[1360px] mt-[120px] flex flex-col items-center justify-center'>
            ...
            <div className='w-[1320px] grid gap-[32px] grid-cols-4 mt-[56px] cursor-pointer '>
                <div className='relative w=[305px] h-[238px] transform hover:scale-105'>
          ...
          <div className='w-[660px] grid grid-cols-2 mt-[110px] transform hover:scale-105'>
