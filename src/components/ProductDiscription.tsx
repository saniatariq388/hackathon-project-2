...
export default function ProductDescription() {
  ...
  return (
    <div className="w-full max-w-[1320px] mx-auto pt-[58px] pb-[120px] ">
    {/* Tab Buttons */}
    <div className="w-[220px] sm:w-1/2 flex flex-col sm:flex-row items-center border-b">
      <button
        onClick={() => setActiveTab("description")}
        className={cn(
          "w-full sm:w-1/2 px-4 sm:px-6 py-2 sm:py-3 font-helvetica text-sm sm:text-base transition-colors text-center",
    ...
    {/* Tab Content */}
    <div className="mt-8 space-y-6 w-[450px] sm:w-1/2">
      {activeTab === "description" ? (
        <>
          {/* Description Text */}
          <p className="text-[#828282] font-inter text-sm sm:text-base leading-5 sm:leading-6">
